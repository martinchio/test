...
import { sendEmail, saveEmail, getEmails, getEmail, getEmailByAddress, deleteEmail } from './email'
...
describe('sendEmail function', () => {
  ...
  it('should throw an error if sending email fails', async () => {
   ...
   it('should save an inbound email', async () => {
        ...
        (Email.create as jest.MockedFunction<any>).mockResolvedValueOnce(mockSavedEmail);
